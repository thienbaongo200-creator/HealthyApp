...
/// Màn hình Dashboard (trang chủ) — theo mô hình Clean Architecture.
///
/// Giữ nguyên toàn bộ State & Logic từ file `main.dart` cũ:
/// - Lắng nghe dữ liệu real-time từ Wear OS (`WatchService.wearDataStream`)
/// - Khởi tạo Local HTTP Server (port 8080) để nhận dữ liệu từ đồng hồ
/// - Đồng bộ dữ liệu lên Django Backend (`ApiService.sendHealthData`)
